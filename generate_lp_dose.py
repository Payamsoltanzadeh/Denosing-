...
def process_dataset(root_dir: str, num_photons: float = 1e5, 
                    num_samples_to_print: int = 3, output_folder_name: str = "lp_cubes"):
    """
    ...
    Folder structure (after):
        ...
        └── {energy}/
            └── {patient_id}/
                ...
                │   └── *.npy
                └── {output_folder_name}/       # NEW: LP dose volumes
                    └── *.npy
    ...
    Args:
        ...
        output_folder_name: Name of the folder to save LP dose (default: "lp_cubes")
    """
    print("=" * 70)
    ...
    for item in tqdm(all_hp_files, desc="Generating LP doses"):
        ...
        # Create lp_cubes folder
        lp_cubes_path = os.path.join(patient_path, output_folder_name)
    ...
    print(f"LP doses saved to: {{patient_path}}/lp_cubes/*.npy")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--root_dir", 
        type=str, 
        default="C:/Users/irpay/OneDrive/Desktop/HESSER/Diffusion_Dose/Mini_Dataset",
    ...
    parser.add_argument(
        ...
        type=str, 
        default="lp_cubes",
        help="Name of the output folder for LP dose (default: lp_cubes)"
    )
